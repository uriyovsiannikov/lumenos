...
static void sglFillFlatBottomTriangle(int x0, int y0, int x1, int y1, int x2,
                                      int y2, unsigned short color);
static void sglFillFlatTopTriangle(int x0, int y0, int x1, int y1, int x2,
                                   int y2, unsigned short color);
/********************************
 *      Public SGL API          *
 ********************************/
void sglSwapBuffers() { xvSwapBuffers(); }
void sglClear(unsigned short color) { xvclroffscreen(color); }
...
void sglDrawTri(int x0, int y0, int x1, int y1, int x2, int y2,
 ...
 *
 */
void sglDrawFilledTri(int x0, int y0, int x1, int y1, int x2, int y2,
                      unsigned short color) {
  if (y0 > y1) {
    swap(y0, y1);
    swap(x0, x1);
 ...
 *
 */
void sglFillFlatBottomTriangle(int x0, int y0, int x1, int y1, int x2, int y2,
                               unsigned short color) {
 ...
 *
 */
void sglFillFlatTopTriangle(int x0, int y0, int x1, int y1, int x2, int y2,
                            unsigned short color) {
