...
static void print_stack_trace(registers_t* regs) {
    ...
    while (ebp && frames < 10) {
        ...
        print("\n", PANIC_BG_COLOR << 4 | PANIC_FG_COLOR);
        if (!ebp[0] || ebp[0] == (uint32_t)ebp) break;
        ebp = (uint32_t*)ebp[0];
        frames++;
    }
}
...
void panic_from_isr(uint32_t interrupt, registers_t* regs) {
    ...
    switch (interrupt) {
        case 0: code = PANIC_DIVISION_BY_ZERO; break;
        case 1: code = PANIC_DEBUG_EXCEPTION; break;
        case 2: code = PANIC_NMI_INTERRUPT; break;
        case 3: code = PANIC_BREAKPOINT; break;
        case 4: code = PANIC_OVERFLOW; break;
        case 5: code = PANIC_BOUND_RANGE_EXCEEDED; break;
        case 6: code = PANIC_INVALID_OPCODE; break;
        case 7: code = PANIC_DEVICE_NOT_AVAILABLE; break;
        case 8: code = PANIC_DOUBLE_FAULT; break;
        case 10: code = PANIC_INVALID_TSS; break;
        case 11: code = PANIC_SEGMENT_NOT_PRESENT; break;
        case 12: code = PANIC_STACK_SEGMENT_FAULT; break;
        case 13: code = PANIC_GENERAL_PROTECTION_FAULT; break;
        case 14: code = PANIC_PAGE_FAULT; break;
        case 16: code = PANIC_FPU_EXCEPTION; break;
        case 17: code = PANIC_ALIGNMENT_CHECK; break;
        case 18: code = PANIC_MACHINE_CHECK; break;
        case 19: code = PANIC_SIMD_EXCEPTION; break;
        case 20: code = PANIC_VIRTUALIZATION_EXCEPTION; break;
        default: code = PANIC_UNKNOWN; break;
    }
