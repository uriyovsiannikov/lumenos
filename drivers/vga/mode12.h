...
#define MODE12_H
#include "register.h"
static const ExternalGeneral extRegs12 = {.miscOutput = 0xE3};
static const Sequencer seqRegs12 = {.reset = 0x03,
                                    .clockingMode = 0x01,
                                    .mapMask = 0x0F,
                                    .charMapSelect = 0x00,
                                    .seqMemoryMode = 0x06};
static CRTController crtcRegs12 = {.horizontalTotal = 0x5F,
                                   ...
                                   .lineCompare = 0xFF};
static const GraphicsController gfxcRegs12 = {.setReset = 0x00,
                                              .enableSetReset = 0x00,
                                              .colorCompare = 0x00,
                                              .dataRotate = 0x00,
                                              .readMapSelect = 0x00,
