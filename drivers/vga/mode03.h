...
#define MODE03_H
#include "register.h"
static const ExternalGeneral extRegs03 = {.miscOutput = 0x67};
static const Sequencer seqRegs03 = {.reset = 0x03,
                                    .clockingMode = 0x00,
                                    .mapMask = 0x03,
                                    .charMapSelect = 0x00,
                                    .seqMemoryMode = 0x02};
static CRTController crtcRegs03 = {.horizontalTotal = 0x5F,
                                   ...
                                   .lineCompare = 0xFF};
static const GraphicsController gfxcRegs03 = {.setReset = 0x00,
                                              .enableSetReset = 0x00,
                                              .colorCompare = 0x00,
                                              .dataRotate = 0x00,
                                              .readMapSelect = 0x00,
...
static const AttributeController attrcRegs03 = {
    .palette = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39,
