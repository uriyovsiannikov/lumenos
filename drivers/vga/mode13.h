 ...
 * https:
 */
static const ExternalGeneral extRegs13 = {.miscOutput = 0x63};
static const Sequencer seqRegs13 = {.reset = 0x03,
                                    .clockingMode = 0x01,
                                    .mapMask = 0x0F,
                                    .charMapSelect = 0x00,
                                    .seqMemoryMode = 0x0E};
static CRTController crtcRegs13 = {.horizontalTotal = 0x5F,
                                   ...
                                   .lineCompare = 0xFF};
static const GraphicsController gfxcRegs13 = {.setReset = 0x00,
                                              .enableSetReset = 0x00,
                                              .colorCompare = 0x00,
                                              .dataRotate = 0x00,
                                              .readMapSelect = 0x00,
...
static const AttributeController attrcRegs13 = {
    .palette = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
